...
function RecruiterDashboard({ user, shortlistCount }: { user: any; shortlistCount: number }) {
  ...
  const recentActivity = [
    ...
    { action: "Offer sent", name: "Sneha Iyer", detail: "IIT Madras · CS", time: "3h ago", dot: "bg-emerald-500" },
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {metrics.map((m) => (
            ...
            >
              ...
              <div className={`flex items-center gap-1 mt-2 text-[11px] font-medium ${m.trendUp ? "text-emerald-600" : "text-red-500"}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-slate-950 rounded-xl p-5 text-white">
              ...
              {[
                { label: "Verified Candidates", value: "50,000+", color: "text-emerald-400" },
            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-5">
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-2.5 py-2 border-b border-slate-50 last:border-0">
                  <div className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 ${item.done ? "bg-emerald-500" : "border-2 border-slate-200"}`}>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Shield, accent: "emerald", title: "Pre-Verified Profiles", desc: "Every candidate is assessed for technical ability, communication, and cultural fit.", badge: "Quality Assured" },
      ...
      <section className="py-16 md:py-24 bg-slate-950 text-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { metric: "75%", label: "Reduction in hiring time", detail: "Compared to traditional campus hiring", color: "emerald" },
              ...
              const c: Record<string, string> = { emerald: "text-emerald-400", blue: "text-blue-400", amber: "text-amber-400" };
              const b: Record<string, string> = { emerald: "border-emerald-500/30", blue: "border-blue-500/30", amber: "border-amber-500/30" };
              return (
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-100 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-sm font-medium text-emerald-700">847 companies actively hiring right now</span>
            </div>
