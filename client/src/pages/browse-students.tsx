      ...
      <div className="max-w-7xl mx-auto px-6 py-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Sign in to access full profiles, contact details, and hiring tools.
                  </p>
                </div>
              </div>
              <Button
        ...
        <div className="mb-5">
          {isLoading ? (
            ...
            >
              <p className="text-slate-500 text-base font-medium">No candidates match your criteria.</p>
              <p className="text-slate-400 text-sm mt-1">Try adjusting the filters above.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 gap-4" data-testid="grid-students">
          ...
          {students && students.length > 0 && (
            <div className="mt-6 flex justify-center" data-testid="pagination-controls">
              <div className="flex items-center gap-2">
                ...
                <span className="px-4 py-2 text-sm text-slate-500" data-testid="text-page-info">
                  Page {currentPage}
                </span>
            ...
            <Card className="bg-white border border-slate-200">
              <CardHeader className="text-center pb-2">
                ...
                <p className="text-slate-500 text-sm mt-1">
                  You've seen {students.length} preview profiles. Sign in to access all {totalStudentCount.toLocaleString()}+ verified candidates.
                </p>
              </CardHeader>
              <CardContent className="text-center space-y-5 pb-6">
                <div className="grid md:grid-cols-2 gap-4 max-w-md mx-auto">
                  <div className="flex flex-col items-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <h3 className="font-semibold text-slate-800 text-sm mb-0.5">Full Access</h3>
                    <p className="text-xs text-slate-500">Browse all verified profiles</p>
                  </div>
                  <div className="flex flex-col items-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                    <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center mb-2">
                      <Star className="w-5 h-5 text-blue-600" />
                    </div>
                    <h3 className="font-semibold text-slate-800 text-sm mb-0.5">Shortlisting</h3>
                    <p className="text-xs text-slate-500">Save and compare candidates</p>
                  </div>
                </div>
                <Button
                  size="sm"
