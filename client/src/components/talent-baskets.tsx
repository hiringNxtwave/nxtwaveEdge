  ...
  const talentBaskets: TalentBasket[] = [
    {
      ...
      location: "Bengaluru",
      topSkills: ["System Architecture", "Problem Solving", "Database Design", "API Development"],
      avgOjr: 78,
    ...
    },
    {
      ...
      location: "Hyderabad",
      topSkills: ["Data Analysis", "Pipeline Design", "Database Management", "Analytics"],
      avgOjr: 82,
    ...
    },
    {
      ...
      location: "Pune",
      topSkills: ["UI Design", "User Experience", "Frontend Architecture", "Responsive Design"],
      avgOjr: 75,
    ...
    },
    {
      ...
      location: "Mumbai",
      topSkills: ["Full Stack Development", "System Integration", "Database Design", "API Architecture"],
      avgOjr: 71,
